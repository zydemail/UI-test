...
var newPath = fs.workingDirectory + '/spec/uiDiff';
var path = fs.absolute( newPath + '/phantomcss.js' );
var phantomcss = require( path );
var server = require('webserver').create();

var html = fs.read( fs.absolute( newPath + '/demo/coffeemachine.html' ));
...
casper.test.begin( 'Coffee machine visual tests', function ( test ) {
	...
	phantomcss.init( {
		...
		screenshotRoot: fs.absolute( newPath + '/screenshots' ),
		failedComparisonsRoot: fs.absolute( newPath + '/demo/failures' ),
